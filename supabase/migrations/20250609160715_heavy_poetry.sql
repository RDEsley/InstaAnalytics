/*
  # Apply search history table migration manually
  
  This file contains the SQL commands to create the search_history table
  and its associated policies. Copy and paste this into your Supabase SQL editor.
  ...
  3. Performance
    - Add indexes for username, timestamp, and user_id columns
*/
