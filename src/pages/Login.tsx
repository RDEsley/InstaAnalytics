...
const Login: React.FC = () => {
  ...
  // If there's a registered email, use it as the default
  React.useEffect(() => {
    if (registeredEmail) {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Redirect happens automatically through OAuth flow
    } catch (error) {
      // Error is handled by the store and displayed in the UI
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Sign in to your account to analyze Instagram profiles
        </p>
      </div>
